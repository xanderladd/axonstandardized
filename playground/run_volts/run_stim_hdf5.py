...
def run_volts_allen():
    ...
    params_file_path = '../../../../../../../axonstandardized_data/params/params_' + model + '_' + peeling+ '.hdf5'
    stims_file_path = '../../../../../../../axonstandardized_data/stims/' + stim_file + '.hdf5'
...
def run_volts_bbp(): 
    ...
    params_file_path = '../../../../../../../axonstandardized_data/params/params_bbp_' + peeling+ '.hdf5'
    stims_file_path = '../../../../../../../axonstandardized_data/stims/stims_full.hdf5'
...
with open('../../../input.txt', 'r') as f:
    ...
    if model == 'allen':
        run_volts_allen()
    elif model == 'compare_allen':
        run_volts_compare_allen()
    elif model == 'bbp':
        run_volts_bbp()
    else:
        raise NotImplementedError