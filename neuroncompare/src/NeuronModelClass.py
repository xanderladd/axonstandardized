...
neuron_path = f"cell_models/{inputs['model']}"
import os
...
class NeuronModel:
    def __init__(self, mod_dir = './cell_models/M1_TTPC_NA_HH/',#'./Neuron_Model_HH/', 
    ...
    # def update_params_dbg(self, params):
    #     """
    #     Update model parameters and apply them via axon_utils.hoc mechanisms.

    #     Args:
    #         params: List of parameters in order:
    #             [0-16]: Channel conductances
    #             [17-20]: gpas (soma, apical, basal, axon)
    #             [21-22]: cm (all, axon)
    #             [23-24]: e_pas (all, axon)
    #             [25-26]: Ih (soma, dend)
    #     """
    #     h = self.h
    ...
    #     # Set passive parameters for different regions
    #     # For soma
    #     for sec in h.cell.soma:
    #         for seg in sec:
    #             seg.g_pas = params[17]
    ...
    #     # Call working() to apply axon_utils settings
    #     h.working()

    #     # Double-check axon parameters after working()
    #     for sec in h.cell.axon:
    #         for seg in sec:
    #             seg.g_pas = params[20]
    #             seg.cm = params[22]
